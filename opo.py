...
class PantoGraph(Plotter):
    ...
    def xy_to_angles(self, x=0, y=None):
        ...
        inner_angle_1 = acos(
            (self.driver*2 + d12 - self.follower*2) / (2 * self.driver * d1)
        )
        inner_angle_2 = acos(
            (self.driver*2 + d22 - self.follower*2) / (2 * self.driver * d2)
        )
    ...
    def setup_turtle(self):
        """Commented out because turtle_plotter is unavailable."""

        # If you do have the turtle_plotter, uncomment the following lines:
